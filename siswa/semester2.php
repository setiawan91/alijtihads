           	...
           	<div class="col-lg-12">
                ...
                <tbody>
                    ...
                    $sql = mysql_query("SELECT a.*,b.nama_mapel
										...
										where a.id_kelas ='$_SESSION[kelas]' AND a.terbit = 'Y' AND a.semester = 2
					...
					<?php echo"<td>
                            <a href='?page=buka-soal2&id_soal=$r[id_soal]'><i class='fa fa-fw fa-pencil-square-o'></i>Buka Soal Ujian</a>
                        </td>"; ?>	
                    </tr>
                    <?php
                    $no++;
