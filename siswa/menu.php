      ...
      <div class="container">
        ...
        <!-- <h2>SMP AL-IJTIHAD 1 TANGERANG</h2>-->
          ...
          <ul class="nav navbar-nav navbar-right">
            ...
            <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i> <?php echo "$_SESSION[siswa] ";?> <b class="caret"></b></a>
          ...
          <ul class="nav navbar-nav navbar-right">
                ...
                <li>
                    ...
                    <ul class="dropdown-menu multi-level">
                        ...
                        <li><a href="index.php?page=jadwal">Jadwal Siswa</a></li>
                        <li class="divider"></li>
                        <li class="dropdown-submenu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">Ujian</a>
                            <ul class="dropdown-menu">
                        ...
                        <li class="dropdown-submenu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">Raport</a>
                            <ul class="dropdown-menu">
                                <li><a href="index.php?page=raport-semester1">Semester 1</a></li>
                                <li><a href="index.php?page=raport-semester2">Semester 2</a></li>
                            </ul>
                        </li>
                    </ul>
                </li>
