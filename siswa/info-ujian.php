...
<div class="container-fluid">
	...
	<div class="box box-primary">
        ...
        <tr><td>
            ...
            <input type=button class='tombol' value='Kembali' Onclick=window.location.href='index.php?page=buka-soal&id_soal=$_GET[id_soal]'></td></tr>";
        }
        elseif ($data[hits] >= 1){
            ...
            echo "<br><br><p align='left' class='garisbawah'>
                ...
                Onclick=window.location.href='index.php?page=buka-soal&id_soal=$_GET[id_soal]'></p>";
        }
