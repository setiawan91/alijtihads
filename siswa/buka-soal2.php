		...
		<div class="box-body">
			...
			<!--tabel-->
           	<div class="col-lg-12">
						...
						$soal = mysql_query("SELECT * FROM t_soal WHERE id_soal = '$_GET[id_soal]' AND terbit='Y' AND semester = 2");
			...
			if (!empty($cek_soal)){
				...
				while($t=mysql_fetch_array($soal)){
                  ...
                  echo"<tbody><tr><td rowspan=6>$no</td><td>Judul</td><td class='col-md-4'>: $t[judul]</td></tr>
                       ...
                       onclick=\"window.location.href='?page=info-ujian2&id_soal=$t[id_soal]';\"></td></tr>
                       </tbody>";
				$no++;
													}
				echo"</table>
				...
				echo "<script>window.alert('Belum ada soal di mata pelajaran ini.');
                    window.location=(href='index.php?page=semester2')</script>";
				}?>
