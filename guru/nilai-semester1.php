           	...
           	<div class="col-lg-12">
                ...
                <tbody>
                    ...
                    $sql = mysql_query("SELECT a.*, b.nama as nama_guru, b.gelar, c.nama_mapel, d.nama_kelas FROM t_jadwal a 
										...
										where a.id_guru ='$_SESSION[id_guru]' and a.semester = 1");
                    $no = 1;
                    ...
                    <?php echo"<td class='col-md-2'>
                            <a href='?page=nilai-uts-siswa&id_guru=$r[id_guru]&id_kelas=$r[id_kelas]&id_mapel=$r[id_mapel]'><i class='fa fa-fw fa-edit'></i>UTS</a> |     
                            <a href='?page=nilai-uas-siswa&id_guru=$r[id_guru]&id_kelas=$r[id_kelas]&id_mapel=$r[id_mapel]'><i class='fa fa-fw fa-edit'></i>UAS</a>
                        </td>"; ?>    
                    </tr>
                    <?php
                    $no++;
