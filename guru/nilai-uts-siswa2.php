...
<div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Input Nilai <small>UTS Siswa</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
 ...
 <table id="example2" class="table table-bordered">
        ...
        <form id="mainform" action="add-nilai-uts2.php" method="post">
        ...
        while($row=mysql_fetch_array($view)){
            ...
            <tr>
                ...
                echo "<input type='text' class='text' name='nilai".$i."' size='10' value='$p[uts]'>";
                echo "<input type='hidden' class='text' name='id_nilai_siswa' value='$p[id_nilai_siswa]'>";
                echo "<input type='hidden' class='text' name='uts' value='uts'>";    
                ?></td>
                
                <td><center><?php echo"<a href='index.php?page=edit-nilai-uts2&id_siswa=$row[id_siswa]&id_mapel=$_GET[id_mapel]&id_kelas=$_GET[id_kelas]&id_guru=$_GET[id_guru]'>
                Edit</a>";?></center></td>
            </tr>
            <?php
            $i++;
