                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Edit Nilai <small>UTS siswa</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
...
<form method='post' action='update-nilai2.php' enctype='multipart/form-data'>
...
?>
    <tr>
        ...
        <td> : </td>
        <td><input type='text' name='nilai' class="form-control" value='<?php echo $p[uts]; ?>'>*Update Nilai</td>
    </tr>
