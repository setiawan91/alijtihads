           	...
           	<div class="col-lg-12">
                ...
                <tbody>
                    ...
                    $sql = mysql_query("SELECT a.*, b.nama as nama_siswa, c.judul, d.nama_mapel, e.nama_kelas FROM t_nilai a 
										...
										where a.id_soal ='$_GET[id_soal]' and c.semester = 1");
                    $no = 1;
                    ...
                    <?php echo"<td> 
                            <a href='?page=delete-nilai&id_nilai=$id_nilai&id_soal=$id_soal&id_siswa=$id_siswa' onClick=\"return confirm('Anda yakin ingin menghapus nilai a/n $r[nama_siswa] ?')\"><i class='fa fa-fw fa-trash-o'></i>Delete</a>
                        </td>"; ?>    
                    </tr>
                    <?php
                    $no++;
