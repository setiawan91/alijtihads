		...
		<div class="box box-primary">
			...
			<div class="box-body">
                ...
                <tbody>
                    ...
                    <?php echo"<td>
                            <a href='?page=edit-soal-pg2&id_pg=$r[id_pg]'><i class='fa fa-fw fa-pencil-square-o'></i>Edit</a> | 
                            <a href='?page=delete-soal-pg2&id_pg=$r[id_pg]&id_soal=$r[id_soal]' onClick=\"return confirm('Anda yakin ingin menghapus soal $r[pertanyaan] ?')\"><i class='fa fa-fw fa-trash-o'></i>Delete</a>
                        </td>"; ?>
                    </tr>
                    <?php
                    $no++;
