...
<div class="container-fluid">
 ...
 <table id="example2" class="table table-bordered">
        ...
        <form id="mainform" action="add-nilai-uas2.php" method="post">
        ...
        while($row=mysql_fetch_array($view)){
            ...
            <tr>
                ...
                <td><center><?php echo"<a href='index.php?page=edit-nilai-uas2&id_siswa=$row[id_siswa]&id_mapel=$_GET[id_mapel]&id_kelas=$_GET[id_kelas]&id_guru=$_GET[id_guru]'>
                Edit</a>";?></center></td>
            </tr>
            <?php
            $i++;
