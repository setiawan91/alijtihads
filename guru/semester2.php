        ...
        <div class="col-lg-12">
                ...
                <tbody>
                    ...
                    $sql = mysql_query("SELECT a.*, b.nama_kelas, c.nama_mapel 
                                        ...
                                        WHERE a.semester = 2 and a.pembuat = '$_SESSION[id_guru]'
                    ...
                    <?php echo"<td class='col-md-3'>
                            <a href='?page=daftar-soal2&id_soal=$r[id_soal]'><i class='fa fa-fw fa-pencil-square-o'></i>Daftar Soal</a> |
                            <a href='?page=lihat-nilai2&id_soal=$r[id_soal]'><i class='fa fa-fw fa-eye'></i>Lihat Nilai Siswa</a> |<br>
                            <a href='?page=edit-soal2&id_soal=$r[id_soal]'><i class='fa fa-fw fa-pencil-square-o'></i>Edit Soal</a> | 
                            <a href='?page=delete-soal2&id_soal=$r[id_soal]' onClick=\"return confirm('Anda yakin ingin menghapus soal $r[judul] ?')\"><i class='fa fa-fw fa-trash-o'></i>Delete</a>
                        </td>"; ?>
                    </tr>
                    <?php
                    $no++;
