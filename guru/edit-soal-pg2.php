    ...
    <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-dashboard"></i> Edit Daftar Soal PG Semester 2
                            </li>
                        </ol>
                    </div>
                </div>
...
?>
           		<form class="form-horizontal" method="post" action="update-pg2.php" enctype="multipart/form-data" onsubmit="return validasi_input(this)" >
