                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Siswa <small>edit data siswa</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
...
$foto = $r['foto']; 
?>
        <form class="form-horizontal" method="post" action="update-siswa.php" enctype="multipart/form-data" onsubmit="return validasi_input(this)">
			
					<div class="form-group">
						<label class="control-label col-sm-2" for="email">NIS :</label>
						<div class="col-sm-3">
            <input type="hidden" name="id_siswa" class="form-control" id="id_siswa" value="<?php echo $r['id_siswa'] ?>" required>
						<input type="text" name="nis" class="form-control" maxlength="16" id="nis" value="<?php echo $r['nis'] ?>" readonly required>
						</div>
            ...
            ?>
					...
					<div class="form-group">
						...
						<select id="kelas" name="kelas" class="selectpicker" data-live-search="true" title="Pilih kelas ...">
							...
							?>  
							<?php echo '<option value="'.$q['id_kelas'].'" '.($r['kelas']==$q['id_kelas']?"selected":"").'>'.$q['nama_kelas'].'</option>';?>		
							<?php } ?>
						</select>
						</div>	
					</div>
